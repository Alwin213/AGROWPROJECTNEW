...
const Login = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    const storedData = JSON.parse(localStorage.getItem('landlordDetails'));
    ...
    if (
      ...
      setTimeout(() => navigate('/dashboard/landlord'), 1500);
    } else {
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 px-4">
      <div className="bg-white p-8 rounded-xl shadow-xl w-full max-w-md text-center">
        ...
        <p className="text-center text-sm text-gray-600 mt-5">
          ...
          <a href="/signup-landlord" className="text-blue-600 font-medium hover:underline">
            Sign up
          </a>
        </p>
      </div>
