...
function SignUpLandlord() {
  ...
  // Save to localStorage under a key "landlordDetails"
  ...
  setTimeout(() => {
    setPopup(false);
    navigate("/login"); // redirect to landlord login page
  }, 1500);
};
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-300 via-blue-500 to-purple-600">
      <div className="bg-white p-8 rounded-xl shadow-xl w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6 text-center text-gray-700">Landlord Sign Up</h2>
